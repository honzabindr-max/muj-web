...
**Aktuální slice:** BUILD-02 — Neon data layer (schema/migrace/testy AT GREEN, Neon provisioning čeká na Honzíkovo GO — viz poznámka níže). BUILD-01 [PR #11](https://github.com/honzabindr-max/muj-web/pull/11) čeká na merge GO.
