...
**STAV 2026-09-23: vývoj H2 Buddy (BUILD-12+) je POZASTAVENÝ kvůli nákladové architektuře.** Výjimka schválená ownerem 23. 9.: pilotní nástroj **H2-IW — H2 Inbox Watcher** (není BUILD blok, viz sekce „Pilotní nástroje" níže a [DEC-009](./DECISIONS.md#dec-009)). **H2-IW: ROZDĚLANÉ** — kód + 125 offline testů, živý eval proti Haiku 19/20, PR z větve `h2/inbox-watcher`; na VPS nainstalováno bez timeru, čeká na secrets ownera.
