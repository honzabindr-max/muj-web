...
| BUILD-04 | Unified ingestion | AT GREEN lokálně — NEMERGNUTO, čeká na GO (merge + env + migrace 0014) | AT-01, AT-02, AT-48, AT-61 | branch `build/h2-build-04-unified-ingestion`, PR bude otevřen; viz sekce výše |
