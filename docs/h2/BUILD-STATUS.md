...
**Shrnutí závislostí (aktualizace 2026-09-04):** #36 (tolerantní parser) MERGED. Zbývá: #37 (re-auth, čeká na CI+GO) → ruční aktivace DRAFT v6 (Honzíkův krok, vyžaduje prohlížeč) → PR [#38](https://github.com/honzabindr-max/muj-web/pull/38) (Structured Outputs, bod 4, čeká na GO k mergi, nezávislý na #37) → **[docs/h2/BUILD-11-PLAN.md](./BUILD-11-PLAN.md) — NÁVRH, čeká na Honzíkovo schválení celého plánu, NEIMPLEMENTOVÁNO** (trigger, voice payload_type fix, retry taxonomie, `owner_control_epoch` kontrola/Pravidlo 10, quarantine notice seam, PR [#35](https://github.com/honzabindr-max/muj-web/pull/35) `MANUALLY_CLEARED` pořadí).
