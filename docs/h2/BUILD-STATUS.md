...
| v2: INFO/EVENT podle aktéra, typ COMMAND, šifrování notes+commands (DEC-009 doplněk 2) | ROZDĚLANÉ — kód + `pytest` 211/211 + eval **41/41** (0,1219 USD); čeká na volbu šifrovacího klíče, pak deploy | větev `h2/inbox-watcher-v2` |
