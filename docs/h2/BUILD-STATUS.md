...
| v5: Planning OS v0.4 — `life` → 6 kalendářů života, BUSY/FREE, 60/15 min, chybějící kalendář = ❓ (DEC-009 doplněk 5) | ROZDĚLANÉ — PR otevřen, **deploy čeká na „kalendáře hotové"** | `pytest` 311/311, eval **66/66** (typ + druh času + datum) |
